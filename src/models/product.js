...
export default class Product {
  ...
  async getProducts() {
    try {
      const res = await axios(`${config.baseUrlAPI}/api/v1/product`);
  ...
  async getProduct(id) {
    try {
      const res = await axios(`${config.baseUrlAPI}/api/v1/product/${id}`);
      console.log(res);
  ...
  async add(fd) {
    try {
      ...
      const res = await axios.post(`${baseUrlAPI}/api/v1/product`, fd, config);
  ...
  async delete(Id) {
    try {
      ...
      const res = await axios.delete(`${baseUrlAPI}/api/v1/product/${Id}`, {
        headers: {
          Authorization: `Bearer ${jwt}`
        }
      });
